...
$.fn.fillForm = function(obj){
	...
	for(x in obj){
		key = x;
		value = obj[x];
		$($(this).selector + " [name='" + key + "'],"+ $(this).selector +" [name='" + key + "[]']").each(function(){
			...
			if(tagName == 'INPUT'){
				if(type == 'radio'){
					...
					arr = value instanceof Array?value: value.split(',');
