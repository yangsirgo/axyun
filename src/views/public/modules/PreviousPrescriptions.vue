  ...
  <div class="width100 height100" v-loading="loading">
    ...
    >
      <el-collapse v-model="activeNames">
        ...
        >
          <template slot="title">
            <div class="width100" style="position: relative;">
              <span style="position: relative;left: -5px;">{{item.title}}</span>
              <div
          ...
          <template slot="content">
            ...
            >
              ...
              ></el-table-column>
              <el-table-column prop="spec" :label="$t('base.toolBox.spec')" min-width="85"></el-table-column>
            </el-table>
          </template>
        </l-collapse-item>
  ...
  methods: {
    ...
    async loadTable() {
      ...
      try {
        ...
        let response = await getHistoryByPatient(params);
