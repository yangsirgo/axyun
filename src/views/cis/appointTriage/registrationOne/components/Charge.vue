<template>
  <div class="width100 height100 padding10">
    <el-table :data="charge.chargeObj.finClassVOList" style="width: 100%" border>
      <el-table-column prop="classCode" label="费用类型" header-align="center">
    ...
    <div>
        ...
        ><el-col :span="12">
          <el-radio v-model="charge.payType" label="3" border class="payType">
            ...
            <span>
              卡余额
              <span class="font">{{
                charge.chargeObj.balanceMoney.toFixed(2) || "0.00"
              }}</span>
            </span>
          </el-radio>
        </el-col>
      ...
      <div class="bottom-info">
        ...
        <el-row>
          <el-col :span="15" class="mar-top-10" style="text-align:left;">
            <span style="margin-left:30px;">实收</span>
            <el-input
              v-model="charge.realGet"
              class="margin-left-6"
              :change="getBackMoney()"
              :disabled="
                charge.chargeObj.cashPay <= 0
              "
            ></el-input>
            <span class="margin-left-6 main-color font">{{ charge.warning }}</span>
          </el-col>
          <el-col :span="6" class="mar-top-20" style="text-align:left;">
            <span>
              找零
...
export default {
  ...
  methods: {
    ...
    // 判断付款方式
    chargrType() {
      if (this.charge.chargeObj.cashPay && this.charge.chargeObj.cashPay > 0) {
