<template>
  <div class="width100 height100">
    ...
    >
      ...
      <template #list>
        <left-bar executionType="skinTest"></left-bar>
      </template>
      <template #content>
              ...
              <div class="patientInfo-left padding-left-16">
                ...
                <div class="patientInfo-left-b">
                  ...
                  <el-button
                    ...
                    @click="finishClinic"
                    v-if="
                      patientInfoShow.patientAge &&
                        patientInfoShow.recordStatus &&
                        patientInfoShow.recordStatus != 5
                    "
                    >结束就诊</el-button
                  >
                </div>
...
<script>
import tabWrapper from "@/views/cis/treatment/tabWrapper.vue";
import leftBar from "@/views/cis/treatment/outpatientNurse/components/leftBar.vue";
    ...
    tabChange(tab) {
      ...
      switch (pageName) {
        ...
        case "electronApply":
          this.layoutObjec = {
            //默认 诊断病历页面
            toolBoxs: ["checkTemp", "HistoricalDiagnosis", "Hotkey"],
            pageName: tab.name,
            boxExpanded: false,
            isToolBox: true
          };
