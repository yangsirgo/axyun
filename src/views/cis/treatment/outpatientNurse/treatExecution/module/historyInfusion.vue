      ...
      <div class="height100 position-relative" v-loading="isLoading">
        <div class="overflow-hidden search-box" style="padding-bottom: 0px;">
          <div class="overflow-hidden" style="font-size:0;">
            <l-formt-title label="治疗开始时间" style="width: 35%;margin-right: 8px" class="position-relative float-left">
              <el-date-picker
                v-model="dateRange"
        ...
        <div class="right" style="padding-top: 10px;height:calc(100% - 30px)">
          <div style="margin-top: 5px;height:calc(100% - 4px)">
            <el-table
              height="100%"
