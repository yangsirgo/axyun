  ...
  <el-card class="height100 wrapperCls">
    <div class="topPart">
      <div class="tablePart">
        <div class="tablePartUtils">
          <div class="overflow-hidden search-box padding16" style="display:flex;align-items:center;">
            ...
            <div class="overflow-hidden" style="font-size:0;">
              ...
              <el-button plain @click="splitFn" :disabled="splitFnStyle">拆分</el-button>
              <el-button plain @click="splitAllFn" :disabled="splitFnStyle">全部拆分</el-button>
              <el-button plain @click="printCard(1)">打印注射卡</el-button>
    ...
    <el-row class="bottomForm">
      ...
      <div class="bottomForm-table">
        <el-table :data="record.recordData" v-if="recordDataSty" border ref="recordsTable" height="100%" style="width: 100%"
    ...
    <el-dialog title="执行确认" :visible.sync="dialogFormVisible">
      <el-form ref="ruleForm" class="tempDialogs" :model="form" :rules="diaFormRules" v-loading="dialogLoading">
        <el-form-item label="" prop="execTime">
          <l-formt-title :required="true" label="选择开始注射时间" class="position-relative float-left">
            <el-date-picker v-model="form.execTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择时间">
            </el-date-picker>
          </l-formt-title>
        </el-form-item>
...
<script>
  import {
    injectionList
  } from "@/api/cis/treatment/injection";
  import {
    getExecResult
  } from "@/api/cis/opnw/opnw";
  import {
    mapGetters
  } from "vuex";
  import {
  ...
  import { getPrintData, printButtoData } from "@/api/cis/visit/visit";
  ...
  export default {
    ...
    data() {
      return {
        ...
        divisionOrdersParams: {
          ...
          execStatus: "",
          execTime: "",
          execType: "1", // 执行类型   0-输液  1-注射  2-皮试  3-治疗'
          ids: "",
          opentionType: "",
          remark: "",
          startDate: "",
        ...
        form: {
          ...
          startDate: "",
          endDate: "",
          execType: "1", //执行类型0-输液  1-注射  2-皮试  3-治疗',
          id: ''
        },
        diaFormRules: {
          execTime: [{
    ...
    groupingPrint(list1) {
      ...
      async printCardFuc(type, orderId) {
        try{
          let params = {
            ...
            printGroup: 2 //1.门诊皮试单、2.门诊注射单、3.输液执行单、4.门诊治疗单
          };
      ...
      doDivisionOrders() {
        ...
        divisionOrders(this.divisionOrdersParams).then(res => {
          ...
          .catch(err => {
            console.log('divisionOrders-------+', err)
            // this.loading = false;
            this.$message.error(err.msg);
          });
      },
     ...
     async execRpBefore() {
       ...
       if (arr.length) {
         ...
         for (let i = 0; i < objList.length; i++) {
           if (objList[i].flag == '3') {
             objhtml += objList[i].msg;//msg报错显示
           } else if (objList[i].flag == '1') {
             objhtmlText += objList[i].msg;//确认是否继续执行显示
             flag = 1;
           } else {
             flag = 2;
           }
    ...
    async execRp(execId) {
      ...
      getExecResult() {
        ...
        // if (this.waitExecRp && (this.waitExecRp.execStatus == '0' || this.waitExecRp.execStatus == '3')) {
          this.form = {
            execTime: '',
