  ...
  <div class="height100">
    <el-table
      ...
      <el-table-column label="性别" width="80" align="center">
        <template slot-scope="scope">{{ scope.row.patientGender == '1' ? '男':'女' }}</template>
      </el-table-column>
      <el-table-column
        prop="age"
        width="70"
...
<script>
  ...
  import {getPatients, receive, findAllergy, selectPatientBySth, findPatientListExecutoryContractByExecType, findPatientListExecutoryContractHisStory} from "@/api/cis/visit/visit";
  ...
  export default {
    ...
    methods: {
      ...
      loadData(noLoading) {
        ...
        console.log('判断标签页',this.activeTabName);//判断标签页

        try {
          if(this.activeTabName == 'second'){
            findPatientListExecutoryContractHisStory(params, false).then(res => {
          ...
          // findPatientListExecutoryContractHisStory
