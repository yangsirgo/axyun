<template>
  <div class="height100 table_tabs_wrapper">
    <el-tabs class="height100 table_tabs" v-model="activeName" @tab-click="tabClick" v-loading="loading">
      <el-tab-pane name="first">
        ...
        <patient-table ref="patientsTable" :params="params" :executionType="executionType"></patient-table>
      </el-tab-pane>
      <el-tab-pane name="second" lazy>
        <div slot="label">
          <span> {{titleLabel}}历史</span>
          <!-- <span>(2)</span> -->
        </div>
        <patient-table ref="patientsHistTable" :params="params" :executionType="executionType"></patient-table>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
...
<script>
  ...
  import {getPatients, receive, findAllergy, selectPatientBySth, findPatientListExecutoryContractByExecType} from "@/api/cis/visit/visit";
  import {mapActions, mapGetters} from 'vuex'
  import skinTesting from "../skinTesting.vue";
  import patientTable from "../tableModule.vue";
  ...
  export default {
    ...
    components: {skinTesting, patientTable},
    methods: {
      ...mapActions({
      ...
      loadData(noLoading) {
        ...
        this.$refs.patientsTable.loadData(null,this.params);
        this.$refs.patientsHistTable.loadData(null,this.params);
        // this.showData = {
        //   wait: [],
        //   received: [],
        //   all: []
        ...
        //   execType: this.executionType == 'infusion'?0:this.executionType == 'injection'?1:3,
        // }
        // try {
        //   findPatientListExecutoryContractByExecType(params, false).then(res => {
