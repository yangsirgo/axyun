  ...
  <div class="addFM">
    <el-form class="table_form" ref="refForm" :model="TableForm">
      <main class="table_main">
            ...
            <div class="rowChildren center">
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item class='gridStyle'>
                    <!-- <el-input   :readonly="true" v-model="HomeDocVO.grid">
                    </el-input> -->
                     <el-cascader v-model="HomeDocVO.grid" disabled :options="neighborhoodGridOptions" clearable></el-cascader>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                  ...
                  <div>
                    <el-form-item>
                      <el-input
                        ...
                        :readonly="true"
                        v-model="HomeDocVO.fixedTelephone"
                      >
                        <!--<template slot="append">℃</template>-->
                      </el-input>
                    </el-form-item>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input   :readonly="true" v-model="HomeDocVO.mobilePhone">
              ...
              <el-row>
                ...
                <el-col :span="16">
                  <div>
                    <el-form-item>
                      <el-input   :readonly="true" v-model="HomeDocVO.address">
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <div class="lh28 flex_cs">
                    <div>
                      <el-radio-group :disabled="true" class="ml-10" v-model="HomeDocVO.familyType">
                ...
                <el-col :span="6">
                  <div>
                    <el-form-item>
                      <el-input   :readonly="true" v-model="HomeDocVO.postalCode">
                        <!--<template slot="append">cm</template>-->
                      </el-input>
                    </el-form-item>
                  </div>
              ...
              <el-row>
                  ...
                  <div>
                    <el-form-item>
                      <el-input
                        ...
                        :readonly="true"
                        v-model="HomeDocVO.familyPopulation"
                      >
                        <!--<template slot="append">℃</template>-->
                      </el-input>
                    </el-form-item>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input   :readonly="true" v-model="HomeDocVO.currentPopulation">
                      <!--<template slot="append">次/分钟</template>-->
                    </el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input   :readonly="true" v-model="HomeDocVO.familyNum">
                      <!--<template slot="append">次/分钟</template>-->
                    </el-input>
                  </el-form-item>
                </el-col>
            ...
            <div class="rowChildren center">
              <el-row>
                ...
                <el-col :span="6">
                  <div class="lh28 flex_cs">
                    <div>
                      <el-radio-group :disabled="true" class="ml-10" v-model="HomeDocVO.homeLocationMedicalStation">
                    ...
                    <PFormInput class="mr-10">
                      <el-input
                        ...
                        :disabled="true"
                        v-model="HomeDocVO.homeLocationMedicalStation"
                      ></el-input>
                    </PFormInput>
                  </div>
                </el-col>
                ...
                <el-col :span="6">
                  <div class="lh28 flex_cs">
                    <div>
                      <el-radio-group class="ml-10" :disabled="true" v-model="HomeDocVO.homeLocationHighway">
                        <el-radio label="1">1-近</el-radio>
                        <el-radio label="2">2-远</el-radio>
                        <!--<el-radio label="3">3-说不清楚</el-radio>-->
                        <!--<el-radio label="4">4-不大满意</el-radio>-->
                    ...
                    <PFormInput class="mr-10">
                      <el-input
                        ...
                        :disabled="true"
                        v-model="HomeDocVO.homeLocationHighway"
                      ></el-input>
                    </PFormInput>
                  </div>
                </el-col>
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <div class="lh28 flex_cs">
                    <div>
                      <el-radio-group class="ml-10" :disabled="true" v-model="HomeDocVO.homeLocationShop">
                        <el-radio label="1">1-近</el-radio>
                        <el-radio label="2">2-远</el-radio>
                        <!--<el-radio label="3">3-说不清楚</el-radio>-->
                        <!--<el-radio label="4">4-不大满意</el-radio>-->
                    ...
                    <PFormInput class="mr-10">
                      <el-input
                        ...
                        :disabled="true"
                        v-model="HomeDocVO.homeLocationShop"
                      ></el-input>
                    </PFormInput>
                  </div>
                </el-col>
                ...
                <el-col :span="6">
                  <div class="lh28 flex_cs">
                    <div>
                      <el-radio-group class="ml-10" :disabled="true" v-model="HomeDocVO.homeLocationPoliceStation">
                        <el-radio label="1">1-近</el-radio>
                        <el-radio label="2">2-远</el-radio>
                        <!--<el-radio label="3">3-说不清楚</el-radio>-->
                        <!--<el-radio label="4">4-不大满意</el-radio>-->
                    ...
                    <PFormInput class="mr-10">
                      <el-input
                        ...
                        :readonly="true"
                        v-model="HomeDocVO.homeLocationPoliceStation"
                      ></el-input>
                    </PFormInput>
                  </div>
                </el-col>
          ...
          <el-col :span="22">
            <div class="rowChildren center">
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input   :readonly="true" v-model="HomeDocVO.area">
                      <!--<template slot="append">℃</template>-->
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :span="6">
                  <div class="lh28 flex_cs">
                    <div>
                      <el-radio-group class="ml-10" :disabled="true" v-model="HomeDocVO.homeType">
              ...
              <el-row>
                ...
                <el-col :span="16">
                  <div class="lh28 flex_cs">
                    <div>
                      <el-radio-group class="ml-10" :disabled="true" v-model="HomeDocVO.lighting">
          ...
          <el-col :span="22">
            <div class="rowChildren center">
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input   :readonly="true" v-model="HomeDocVO.householdIncome">
                      <!--<template slot="append">℃</template>-->
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input   :readonly="true" v-model="HomeDocVO.familyFacilities">
                      <!--<template slot="append">℃</template>-->
                    </el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row>
                ...
                <el-col :span="14">
                  <el-form-item>
                    <el-input   :readonly="true" v-model="HomeDocVO.familyFunctionAssessment">
                      <!--<template slot="append">℃</template>-->
                    </el-input>
                  </el-form-item>
                </el-col>
            ...
            <div class="rowChildren center">
              <el-row>
                ...
                <el-col :span="6">
                  ...
                  <!--</el-form-item>-->
                  <!--</div>-->
                  <el-select :disabled="true" v-model="HomeDocVO.docDoctor">
                    <el-option
                      v-for="item in docDoctors"
                      :key="item.id"
                      :label="item.label"
                      :value="item.id">
                    </el-option>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input  :readonly="true" v-model="HomeDocVO.docTime">
                      <!--<template slot="append">次/分钟</template>-->
                    </el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input  :readonly="true" v-model="HomeDocVO.docCurrentHos">
                      <!--<template slot="append">次/分钟</template>-->
                    </el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row>
                ...
                <el-col :span="16">
                  <div>
                    <el-form-item>
                      <el-input  :readonly="true" v-model="HomeDocVO.docUpdateRecord">
                        <!--<template slot="append">cm</template>-->
                      </el-input>
                    </el-form-item>
                  </div>
              ...
              <el-row>
                ...
                <el-col :span="16">
                  <!--<div>-->
                  <!--<el-form-item>-->
                  <!--<el-input v-if="!readonly" :readonly="true" v-model="TableForm.height">-->
                  <!--&lt;!&ndash;<template slot="append">cm</template>&ndash;&gt;-->
                  <!--</el-input>-->
                  <!--</el-form-item>-->
                  <!--</div>-->
                  <el-select :disabled="true" v-model="HomeDocVO.responsibleDoctor" style="width: 100%">
                    <el-option
                      v-for="item in respDoctors"
                      :key="item.id"
                      :label="item.label"
                      :value="item.id">
                    </el-option>
              ...
              <el-row>
                ...
                <el-col :span="16">
                  <div>
                    <el-form-item>
                      <el-input  :readonly="true" v-model="HomeDocVO.registrationDate">
                        <!--<template slot="append">cm</template>-->
                      </el-input>
                    </el-form-item>
                  </div>
        ...
        <div>
          <div style="text-align: center">家庭成员列表</div>
          <el-col :span="24">
            <el-table
              :data="data1"
              border
...
<script>
  ...
  import {getBaseHomDoc, onQueryDocIndex,saveBaseHomDoc,viewBaseHomDoc} from "@/api/phss/family_maintenance/family_maintenance";
  export default {
    name: "addFM",
    components: {},
    props: ["data"],
    ...
    mounted() {
      ...
      if(this.data.status == 'modify'){
        ...
        this.data1 = this.data.rowData.familyInformationVOList;
        // console.log("===========查看家庭成员信息===============",this.data.rowData);
      }
      this.baseData({"ad": "123"});
      this.load({"homeCode": this.HomeDocVO.homeCode});
    },
    methods: {
      load(data){
        viewBaseHomDoc(data)
          .then(res => {
            // console.info("============家庭关系=============", res.data);
            this.data1 = res.data;
          }).catch(error => {
          console.log(error);
        });
      ...
      familyHistory(data) {
        if(data.household_realtion_status == '01'){
          this.HomeDocVO.houseHolder = data.rsdt_name;
        }
        this.HomeDocVO.members.push(data);
      },
      peopleData(data) {
        onQueryDocIndex(data).then(res => {
          this.data1 = res.data;
        }).catch(error => {
          console.log(error);
        })
