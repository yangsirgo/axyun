<template >
  <div :class="TableDialogClass">
    <div v-if="loading">
      <PGlobalStepView v-if="maxActive!=1" :active="active" />
      <keep-alive>
        <component ref="tableRef" :is="curComponent"></component>
      </keep-alive>
    </div>
    <span v-if="loading" slot="footer" class="fr">
      <!-- <el-button v-if="status != 'view'" @click="saveFun">默认值</el-button> -->
      <!-- <el-button v-if="status != 'view'" @click="saveFun">清 空</el-button> -->
      <!-- <el-button v-if="status != 'view'" @click="OnClose">取 消</el-button> -->
