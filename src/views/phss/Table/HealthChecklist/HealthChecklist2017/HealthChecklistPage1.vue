<template>
  <div class="HealthChecklistPage1">
    <el-form class="table_form" ref="refForm" :model="TableForm">
      <header class="table_header">
        ...
        <el-row class="mb-10" type="flex" justify="space-between">
          ...
          <el-col :span="18">
            <div class="fr">地址:{{current_address}}</div>
          </el-col>
        </el-row>
      </header>
          ...
          <el-col :span="22">
            <div class="lh20 padding-10">
              <PCheckbox
                ...
                :symptom="true"
                :formKey="'symptom'"
                :otherKey="'symptom_other'"
                :otherData="TableForm.symptom_other"
                :checkboxOptions="symptomOptions"
                :checkboxForm="chObject.symptom"
                :clearFlag="clearFlag"
              />
            </div>
          </el-col>
                            ...
                            <div class="flex_cs w100">
                              ...
                              <el-form-item>
                                <el-input
                                  v-if="!readonly"
                                  :readonly="readonly"
                                  v-model="TableForm.quit_drinking_age"
                                ></el-input>
                              </el-form-item>
                            </div>
                          </el-radio-group>
  ...
  methods: {
   ...
   // 责任医生
    ...
    EchoMethod() {
      ...
      // 基本信息
        console.log('1111111111111111111',this.BaseMesData.age)
        this.pap_doc_no = this.BaseMesData.pap_doc_no;//编码
        this.rsdt_name = this.BaseMesData.rsdt_name;//姓名
        this.telephone = this.BaseMesData.telephone; //联系电话
        this.current_address = this.BaseMesData.current_address;//地址
