      ...
      <div class="box">
        <el-card class="height100">
          <div class="top-btn">
            ...
            <span class="float-right btn-label" @click="adds"><i class="iconfont iconxinzeng"></i>批量新增</span>
            <span class="float-right btn-label" @click="newAdd"><i class="iconfont iconxinzeng"></i>新建申请单</span>
          </div>
          <div class="padding20">
            <div class="title">
              申请单
            ...
            <div class="apply-info">
              <div>
                ...
                <l-formt-title class="form-item" label="申请药库" labelWidth="64">
                  <el-select v-model="applyInfo.storageCode" placeholder="请选择">
                    <el-option
                      v-for="item in storageCodeList"
                      :key="item.value"
                      :label="item.label"
                      :value="item.value">
                    </el-option>
              ...
              <div>
                <l-formt-title label="备注" labelWidth="32">
                  <el-input v-model="applyInfo.remark" placeholder=""></el-input>
                </l-formt-title>
              </div>
              <div>
                  ...
                  <el-table
                    ...
                    <el-table-column
                      ...
                      <template slot-scope="scope">
                        ...
                        <el-input v-else v-model="scope.row.stock" placeholder=""></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="参考进价">
      ...
      <div class="box">
        <el-card class="height100">
          <div class="padding20" ref="top">
            ...
            <div class="clearFloat">
              ...
              <div class="float-left">
                <l-formt-title label="申请药库" labelWidth="64">
                  <el-select v-model="formSearch.storageCode" placeholder="">
                    <el-option
                      v-for="item in storageCodeList"
                      :key="item.value"
                      :label="item.label"
          ...
          <div class="sort-container">
            <l-sort-label class="inline-block" label="申请单号" state="2" @click="cardListSort('key1')"></l-sort-label>
