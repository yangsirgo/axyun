          ...
          <div class="table">
            <el-col>
              ...
              <el-col style="text-align: right;">
                <span>日期：</span>
                <span>{{searchData.sDate}}-- {{searchData.eDate}}</span>
                <!-- <el-col :span="6">
            ...
            <el-table ref="singleTable" v-if="singleTableStyle" :data="drugData" border width="100%" height="500" highlight-current-row
              ...
              <el-table-column v-for="(item,index) in tableParams" :key="index" :prop="item.prop" :label="item.label" sortable
                ...
                <template slot-scope='scope'>
                  ...
                  <template v-else-if="item.prop == 'deliveryTime'">
                        <span>{{scope.row.deliveryTime.substring(0,11)}}</span>
                  </template>
    ...
    methods: {
      getSummaries(param) {
        ...
        columns.forEach((column, index) => {
          ...
          if (column.property == 'longDrug' || column.property == 'controlDrug' || column.property == 'controlDrug' ||
            column.property == 'basicDrug' || column.property == 'negotiateDrug' || column.property ==
            'centralizedPurchasingDrug') {
      ...
      dateObjFun() {
        this.searchData.sDate  = this.dateObj[0];
        this.searchData.eDate  = this.dateObj[1];
      ...
      async listForPhaList() {
        ...
        hmmBaseApi.listForLongRecipe(this.searchData).then(res => {
            if (res.code == 1) {
