      ...
      <slot name="content">
        <div class="main">
          ...
          <div class="table">
            ...
            >
              ...
              >
                ...
                <template slot-scope="scope">
                  <template v-if="item.prop == 'drugUnit'">
            ...
            <!-- <el-col>
              <el-col :span="12">
                <el-col>制表人：<span>李想</span></el-col>
              </el-col>
              <el-col :span="12">
      ...
      hmmBaseApi
        ...
        .then(res => {
          if (res.code == 1) {
            ...
            this.$message.error(res.msg || this.listName + "数据失败");
          }
          if (res.data.length === 0) {
            this.$message.error("暂无" + this.listName + "统计数据");
          }
        })
        .catch(res => {
          this.$message.error(res.msg || this.listName + "数据失败");
