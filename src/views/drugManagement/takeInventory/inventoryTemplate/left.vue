  ...
  <el-card class="height100">
    <div style="padding:8px;" ref="top">
      ...
      <el-row style="margin-top: 8px">
        <el-col :span="24">
          ...
          <el-button type="primary" size="small" @click="newAdd">新建模版</el-button>
        </el-col>
      </el-row>
    </div>
    <!--排序-->
    ...
    <div class="infinite-list-wrapper" v-loading="loading">
      ...
      >
        ...
        >
          <div class="tem-delete" @click.stop="deleteTem(item)">
            <i class="filter-item iconfont iconshanchu" title="删除模板"></i>
          </div>
          ...
          if (res.code == 1) {
            if (res.pageNo === 1) {
              ...
              if(this.curSelectedIndex ==""){
                 this.handleSelectedItem(0, this.templateList[0] || {});
              }else{
                this.handleSelectedItem(this.curSelectedIndex, this.templateList[parseInt(this.curSelectedIndex)] || {});
              }
