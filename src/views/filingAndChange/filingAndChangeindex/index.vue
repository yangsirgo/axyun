<template>
  <div class="width100 height100 filingAndChangeindex">
          ...
          <div v-if="htmlShow" class="width100 height100">
            <div class="patient-card">
              <!-- <l-patient-card
                ...
                :patientAge="recordForm.patientAge"
                :patientGender="recordForm.patientGender"
              >
                <patient-basic-info
                  :patientInfo="recordForm"
                ></patient-basic-info>
            ...
            <el-card class="card-cont1 width100 m-contain bottom-con third-con">
              <div class="form-cont height-button-main">
                <el-form ref="recordForm" :model="recordForm" :rules="rules">
                  ...
                  <el-row>
                    <div class="clearfix img-cont">
                      ...
                      <div class="float-left img-left">
                        <el-row :gutter="8" class="margin-bottom-20">
                          ...
                          <el-col :span="3" class="width1024-33">
                            <LFormtTitle label="年龄" disabled>
                              <el-form-item prop="age" disabled>
                                <el-input
                                  :disabled="true"
                        ...
                        >
                          <el-col :span="15" class="width1024-33 paddingLeft">
                            <el-row :gutter="8">
                              <el-col :span="8">
                                <LFormtTitle label="证件">
                                  <el-form-item prop="relationShip">
                                    <l-value-domain
                                      :disabled="disableEditing"
                                      :code="selectCode.identificationType"
                                      :value.sync="
                                        recordForm.identificationType
                                      "
                                      @change="identifiBlur"
                                      class="select-container"
                                      :placeholder="$t('base.placeholder')"
                              ...
                              <el-col :span="16" class="flex flexCls">
                                ...
                                <el-button
                                  ...
                                  @click="bindIdentif">绑定</el-button>
                              </el-col>
                            </el-row>
                          </el-col>
                        ...
                        >
                          ...
                          <!-- <el-col :span="4" class="width1024-33 paddingLeft">
                            <LFormtTitle label="其他电话">
                              <el-form-item prop="otherPhoneNum">
                                <el-input
                                  v-model="recordForm.otherPhoneNum"
                                  maxlength="11"
                                  style="width: 100%"
                                  placeholder="请输入"
                                  @input="inputChange($event)"
                          ...
                          <el-col :span="4">
                            <SZReadCard v-if="oldInsurence" :btnLoading="synchLoading" readCardText="同步深圳医保" @cardInfo="cardInfoHandler" :showCardNum="false" :showPassword="true"></SZReadCard>
                          </el-col>
                          <el-col :span="7">
                        ...
                        <LFormtTitle label="户籍地址">
                          <el-form-item prop="domicile">
                            <l-value-domain
                              ...
                              :value.sync="
                                patientEmpiInfoAddrssVO.houseHoldAddress
                              "
                              class="select-container"
                              remoteValueKey="id"
                              remoteShowKey="label"
                        ...
                        <el-form-item prop="address">
                          <LFormtTitle label="联系地址" required>
                            <l-value-domain
                              ...
                              :value.sync="
                                patientEmpiInfoAddrssVO.currentAddress
                              "
                              class="select-container"
                              remoteValueKey="id"
                              remoteShowKey="label"
                  ...
                  <el-row>
                    <l-card-title
                      ><span slot="left">档案补充信息</span></l-card-title
                    >
                        ...
                        >
                          <el-row :gutter="8" class="margin-bottom-20">
                            ...
                            <el-col
                              ...
                              v-if="
                                index ==
                                recordForm.archGuarantorListA.length - 1
                              "
                            >
                              <span
                    ...
                    >
                      <el-row :gutter="8" class="margin-bottom-20">
                        ...
                        <el-col :span="6">
                          <el-form-item
                            :prop="
                              'archGuarantorList.' + index + '.mobileNum'
                            "
                            :rules="{
                      ...
                      <el-col :span="24">
                        <el-col :span="24">
                          <div
                            ...
                            v-if="recordForm.qrCode"
                          >
                            <el-col class="bgcardList">
                              <el-col :span="14">
                                <el-col :span="24">
                                  <el-col :span="22" class="cardText"
                                    >档案识别码</el-col
                                  >
                                </el-col>
                          ...
                          >
                            <el-col :span="24" class="bgcardList">
                              ...
                              <el-col :span="24">
                                ...
                                <span class="timeNum timebox">{{
                                  substringFun(item.cardTime)
                                }}</span>
                              </el-col>
                            </el-col>
                            <el-col :span="24">
                        ...
                        <el-col :span="24">
                          ...
                          <!-- <div class="cardList cardListC">
                            <el-col
                              class="bgcardList bgcardListplus"
                              @click.native="bind"
                            >
                              <span
                                class="el-icon-plus"
              ...
              <div class="bottom-con width100">
                <div class="btns float-right">
                  ...
                  <el-button type="primary" plain @click="cancelFun"
                    >取消</el-button
                  >
                </div>
              </div>
    ...
    <el-dialog
      ...
      width="80%"
      top="16px"
      class="addarchivesClass"
      :visible.sync="addarchivesStyle"
      v-if="addarchivesStyle"
      append-to-body
    >
      <div style="height:100%;overflow:auto">
        <addarchives @cancelstyle="cancelstyle" source="filingAndChangeindex" @refsChild="refsChild">
        </addarchives>
      </div>
    </el-dialog>
    <!-- 新建档案 end refsChild -->
...
export default {
  ...
  data() {
    ...
    //联系人联系方式
    let concatPhoneArchArch = (rule, value, callback) => {
      let str = /^1([38]\d|4[5-9]|5[0-35-9]|6[56]|7[0-8]|9[189])\d{8}$/;
      if (!value) {
        // this.$message.error('联系方式不能为空');
        // callback(new Error('联系方式不能为空'));
        ...
        this.$message.error("联系人应该是数字");
        callback(new Error("联系人应该是数字"));
      } else if (
        this.recordForm.mobileNum &&
        this.recordForm.mobileNum == value
      ) {
    ...
    let concatPhoneR = (rule, value, callback) => {
      let str = /^1([38]\d|4[5-9]|5[0-35-9]|6[56]|7[0-8]|9[189])\d{8}$/;
      if (value == "") {
        ...
        this.$message.error("联系人电话应该是数字");
        callback(new Error("联系人电话应该是数字"));
      } else {
        callback();
      }
    };
    return {
      ...
      rules: {
        ...
        archPhone: [
          {
            validator: concatPhoneArchArch,
            trigger: "blur",
          },
        ],
        archPhoneRequired: [
          {
            validator: concatPhoneR,
            trigger: "blur",
            required: true
          }
        ],
  ...
  methods: {
    ...
    validateIdentifiNoPass (){
      ...
      console.log(identifiNo, cardType, cardList);
      ...
      if (cardList.length > 0) {
        ...
        if (identiNo) {
          ...
          if (cardType != identificationType) {
            this.$message.error("绑定的卡为身份证，证件类型需要与绑定的证件类型一致!");
            return false;
          }
        }
    ...
    async cardInfoHandler(data) {
      /* this.cardList = []
      let cardData = [{"cardData":"440307197807242348","cardStatus":"1","cardTime":"2021-04-08 20:47:39","cardType":"1"},{"cardData":"6048945017","cardStatus":"1","cardTime":"2021-04-08 20:47:39","cardType":"21"}]
    ...
    getPatientInfo (param){
      return new Promise(async (resolve,reject)=>{
        try {
          let { data, msg, code } = await healthInsuranceService.patientInfo(param);
          if (code == 1) {
      ...
      try {
        ...
        if (code == 1){
          ...
          this.recordForm = {
            ...
            ...{
              archGuarantorList: patientEmpiInfoAdditionalVOS,
          ...
          console.log("recordForm:::::", this.recordForm);
          // console.log("旧的archCardList:::::", JSON.stringfy(this.cardList));
          this.cardList = archCardList;
          // console.log("新的archCardList111:::::", archCardList);
          console.log("新的archCardList222:::::", this.cardList);
          ...
          // this.patientEmpiInfoAddrssVO = patientEmpiInfoAddrssVO;
          // this.recordForm.archGuarantorList = patientEmpiInfoAdditionalVOS;
          // this.recordForm.archGuarantorListA = patientEmpiInfoOtherCredentialsVOS;
    ...
    readTheFun() {
      ...
      console.log(
        this.eHrleftData,
        "eHrleftDataeHrleftDataeHrleftDataeHrleftData"
      );
    },
    openstyle() {
      //打开健康档案
    ...
    patientListFunData(item, showData) {
      ...
      if (item.patientEmpiInfoAddrssVO) {
        for (let obj in this.patientEmpiInfoAddrssVO) {
          ...
          if (obj == "houseHoldAddress" && item.patientEmpiInfoAddrssVO[obj]) {
            let str = [];
          ...
          if (obj == "currentAddress" && item.patientEmpiInfoAddrssVO[obj]) {
            let str = [];
            this.patientEmpiInfoAddrssVO[obj] = item.patientEmpiInfoAddrssVO[
              obj
            ]
        ...
        //zhengyawen
        this.patientEmpiInfoAddrssVO["houseHoldAddress"] = [];
        this.patientEmpiInfoAddrssVO["currentAddress"] = [];
        this.patientEmpiInfoAddrssVO["houseHoldDetail"] = "";
        this.patientEmpiInfoAddrssVO["currentDetail"] = "";
      }
      // 联系人
      if (item.patientEmpiInfoAdditionalVOS) {
        ...
        for (let j = 0; j < item.patientEmpiInfoAdditionalVOS.length; j++) {
          let str = [];
          let strData = [];
          let address = !item.patientEmpiInfoAdditionalVOS[j].address || item.patientEmpiInfoAdditionalVOS[j].address =="[]" ? [] : item.patientEmpiInfoAdditionalVOS[j].address;
          if (address.length) {
            strData = address
              .toString()
              .replace(/\[|]/g, "")
    ...
    async getVeriCode() {
      ...
      if (
        !this.recordForm.identificationNum ||
        this.recordForm.identificationNum.length <= 0
      ) {
    ...
    submit() {
      ...
      this.$refs["recordForm"].validate(async (valid) => {
        if (valid) {
          ...
          // console.log("this.patientEmpiInfoAddrssVO.currentAddress", this.patientEmpiInfoAddrssVO.currentAddress);
          // return
          // 校验联系地址不能为空
          if (this.patientEmpiInfoAddrssVO.currentAddress.length == 0){
          ...
          for(let i in this.recordForm.archGuarantorListA){
            if(this.recordForm.archGuarantorListA[i].identificationType == '1'&&this.recordForm.archGuarantorListA[i].identificationNum){
              let reg = /(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/;
              if (!reg.test(this.recordForm.archGuarantorListA[i].identificationNum)) {
    ...
    //处理患者信息条数据
    handlePatientDetail(item) {
      let data = deepClone(item);
      this.patientInfoShow = {};
      this.detailList = [];
      let patientInfoShow = {
        ...data.patientArchiveInfoVO,
        address:
          data.patientEmpiInfoAddrssVO &&
          data.patientEmpiInfoAddrssVO.currentAddress &&
          JSON.parse(data.patientEmpiInfoAddrssVO.currentAddress).length
            ? JSON.parse(data.patientEmpiInfoAddrssVO.currentAddress)
            : [],
        phoneNum: data.patientArchiveInfoVO.mobileNum,
      };
      this.patientInfoShow = patientInfoShow;
    },
    checkPhoneNum() {
      //let reg = /^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8}$/
      let reg = /^1[0-9]{10}$/;
