...
export default {
  ...
  methods: {
    ...
    combinationModifySave(content) {
      ...
      this.eleDetailInfo.commonAttributeDto.checkDirectCite = this.quote;
    ...
    handlerPropsIn() {
      ...
      this.quote = this.eleDetailInfo.commonAttributeDto.checkDirectCite;
    ...
    asycModify(req) {
      ...
      return detailQuery(req).then((res) => {
        if (res.code === 1) {
          ...
          this.quote = res.data.commonAttributeDto.checkDirectCite;
