...
<script>
  ...
  import examReport from "@/views/cis/integratedEmr/opEmr/examReport/component/examReport.vue"
  import examReport1 from "@/views/public/reportCenter/index.vue"
