  ...
  <div class="height100 width100">
    ...
    <div id="searchBox" class="search-box">
      ...
      <el-checkbox-group class="scopeLevel" v-model="scopeLevel" @change="getSectionTempl">
        <el-checkbox label="1"><span style="width:55px;display: inline-block">体温单</span></el-checkbox>
        <el-checkbox label="2"><span style="width:55px;display: inline-block">护理文书</span></el-checkbox>
        <el-checkbox label="3"><span style="width:55px;display: inline-block">评估结果</span></el-checkbox>
        <el-checkbox label="4"><span style="width:55px;display: inline-block">其他</span></el-checkbox>
      </el-checkbox-group>
    </div>
...
<script>
  import { getList} from "@/api/tools/nursingAssistant";
    ...
    methods: {
      changeDate(){
        ...
        if(this.search.Date!=null){
          if(this.search.Date){
            this.beginDate=this.dateFormat("YYYYmmdd",this.stringToDate(this.search.Date[0]));
            this.endDate=this.dateFormat("YYYYmmdd",this.stringToDate(this.search.Date[1]));
          }
        }
        this.loadData();
      },
