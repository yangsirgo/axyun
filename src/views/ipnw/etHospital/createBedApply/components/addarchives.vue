                ...
                <el-col :span="8">
                  <LFormtTitle label="联系具体地址">
                    <el-form-item prop="detaiAddress">
                      <el-input 
                        maxlength="32"
                        v-model="patientEmpiInfoAddrssVO.currentDetail" style="line-height: 34px;width:100%"
                        placeholder="请输入" @input="inputChange($event)"></el-input>
                    </el-form-item>
                  </LFormtTitle>
                </el-col>
                ...
                <el-col :span="8">
                  <LFormtTitle label="工作单位">
                    <el-form-item prop="company">
                      <el-input
                        maxlength="32"
                        v-model="recordForm.workUnit" style="line-height: 34px;width:100%" placeholder="请输入"
                        @input="inputChange($event)"></el-input>
                    </el-form-item>
                  </LFormtTitle>
                </el-col>
                  ...
                  <el-row :gutter="8" class="margin-bottom-20">
                    ...
                    <el-col :span="6">
                      <LFormtTitle label="具体地址">
                        <el-form-item prop="contactDetailAddress">
                          <el-input maxlength="32" v-model="item.conDetail" style="line-height: 34px;width:100%" @input="inputChange($event)"
                    ...
                    <el-col :span="6">
                      <LFormtTitle label="联系人工作单位">
                        <el-form-item prop="contactDetailAddress">
                          <el-input maxlength="32" v-model="item.workUnit" style="line-height: 34px;width:100%" placeholder="请输入工作单位"
                            @input="inputChange($event)"></el-input>
                        </el-form-item>
                      </LFormtTitle>
                    </el-col>
                    ...
                    <el-col :span="6">
                      <LFormtTitle label="联系人其他单位">
                        <el-form-item prop="contactDetailAddress">
                          <el-input maxlength="32" v-model="item.otherUnit" style="line-height: 34px;width:100%" placeholder="请输入其他单位"
                            @input="inputChange($event)"></el-input>
                        </el-form-item>
                      </LFormtTitle>
                    </el-col>
        ...
        this.$refs['recordForm'].validate(async valid => {
          if (valid) {
            ...
            if (result.code == '1') {
              ...
              // this.$emit('refsChild');
              this.$emit('cancelstyle', false, result.data);// 隐藏model框
