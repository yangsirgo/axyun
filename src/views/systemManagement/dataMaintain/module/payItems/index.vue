      ...
      <div class="form">
        <el-form :model="form" :rules="rules" ref="form" label-width="0">
          <el-form-item prop="finClassCode">
            <l-formt-title label="财务分类码" required disabled>
          ...
          <el-form-item prop="provincialLevelCode">
            <l-formt-title label="省级编码" disabled>
              <el-input
          ...
          <el-form-item prop="medicalRecordClassCode">
            <l-formt-title label="病案分类码" required disabled>
          ...
          <el-form-item prop="chargeItemName">
            <l-formt-title label="收费项目名称" required disabled>
              <el-input
          ...
          <el-form-item prop="chargeItemCode">
            <l-formt-title label="收费项目编码" required disabled>
              <el-input
    ...
    <div class="finance-left el-card height100">
      <div class="search">
        ...
        <div class="search-btn">
          ...
          <el-button type="primary" plain @click="TransferIn">调入</el-button>
        </div>
      </div>
      <div class="table">
        <el-table
...
import {
  ...
  updateChargeItem,
  deleteChargeItem
} from "@/api/systemManagement/dataMaintain/payItems.js";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        chargeItemCode: [{ required: true, message: "请选择", trigger: "blur" }]
      },
      formLoad: false,
