    ...
    <el-card class="account-cont width100">
      ...
      <div class="tabs">
        ...
        >
          <el-tab-pane label="充退记录" name="first" class="width100 height100">
            ...
            <!-- <div class="tabs-foot">
              ...
              <span class="tabs-foot-cont tabs-foot-cont2">
                退款
                <i>{{ accountDetailInfoData.refundPrestoreTotal}}元</i>
              </span>
              <span class="tabs-foot-cont tabs-foot-cont1">
                充值
                <i>{{accountDetailInfoData.prestoreTotal}}元</i>
              </span>
            </div>-->
          </el-tab-pane>
        ...
        <div class="buttons">
          ...
          <el-button
            class="button-cont button-cont2 el-button-cancel"
            @click="freeze"
            v-if="accountDetailInfoData.recordStatus"
          >
            <span v-if="accountDetailInfoData.recordStatus=='1'">冻结</span>
            <span v-else-if="accountDetailInfoData.recordStatus=='2'">解冻</span>
          </el-button>
          <el-button
            class="button-cont button-cont3 el-button-cancel"
            @click="accountRefundDisable=true"
          >退款</el-button>
        </div>
      </div>
    </el-card>
