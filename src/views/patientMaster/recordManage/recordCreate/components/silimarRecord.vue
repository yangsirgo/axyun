<template>
  ...
  <div class="assist-container width100 height100" v-loading="loading">
    ...
    <div v-else style="font-size:16px;color:#909399;text-align:center">暂无相似档案</div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters("patientMaster", ["receivePatientData", "similarRecordData"])
    },
    watch: {
      receivePatientData: {
        async handler(n) {
