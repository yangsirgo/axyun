  ...
  <div class="app-container" ref="page">
    <div class="form-table">
            ...
            >
              <template slot-scope="scope">
                ...
                <template v-if="item.prop == 'operate'">
                  ...
                  <el-button
                    @click="authToRole(scope.$index, scope.row)"
                    type="text"
                    size="small"
                  >角色关联权限</el-button>
                  <el-button
      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" size="mini" @click="confirmRoleToAuth">确认</el-button>
          <el-button type="primary" size="mini" @click="handleClose1">取消</el-button>
        </div>
      </el-dialog>
    </div>
  </div>
