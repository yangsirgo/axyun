...
export function batchRemove(data) {
  return patch('/dataElement/remove', data, true)
}

//数据元维护批量启用停用
export function startupShutdown(data, flag) {
  return post('/dataElement/startupShutdown/' + flag, data, true)
}
...
export function modifyDateElement(data) {
  return post('/dataElement/modify', data, true)
}
//检查数据元值域是否修改
...
//获取seq
export function getSeq(data) {
  return get('/dataElement/seq_no', data, true)
}
